...
\section{Skills}
\resumeSubHeadingListStart
% Add your skills content here. Example:
% \resumeSubSubheading{Programming Languages:}{C#, Java, Python, JavaScript, TypeScript, Go}
% \resumeSubSubheading{Frameworks:}{.NET Core, Spring Boot, React, Angular, Node.js, Semantic Kernel, Orleans}
% \resumeSubSubheading{Cloud Technologies:}{Azure (App Services, AKS, Cosmos DB, Service Bus, Blob Storage, Azure Functions, Azure AI Foundry), AWS}
% \resumeSubSubheading{Tools & Methodologies:}{CI/CD (Azure Pipelines, Helm), Docker, Kubernetes, Git, Unit Testing, A/B Testing, Microservices, RESTful APIs, GraphQL}
\resumeSubHeadingListEnd
